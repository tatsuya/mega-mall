document.addEventListener('DOMContentLoaded', () => {
    ...
    floors: [
      ...
      },
      {
        ...
        stores: [
          ...
          { id: 'b5', name: 'Macy\'s', type: 'department-store', description: 'Department store offering clothing, accessories, and home goods.', actions: ['shop-clothes', 'shop-general'] },
      ...
      },
      {
        ...
        stores: [
          ...
          { id: 'c10', name: 'Sky High Trampoline Park', type: 'entertainment', description: 'Indoor trampoline park with various jump activities and foam pits.', actions: ['play-games', 'jump-trampoline'] },
  ...
  function performAction(action, store) {
    const costs = {
      ...
      'withdraw-cash': { money: 2000, energy: -2, happiness: 5 },
  ...
  function getActionMessage(action, storeName) {
    const messages = {
      ...
      'withdraw-cash': `You withdrew $2,000 from the ATM!`,
